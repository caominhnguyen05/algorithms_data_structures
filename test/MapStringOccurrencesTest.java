...
class MapStringOccurrencesTest {
    @Test
    void testCountSubstringOccurrences() {
        ...
        Map<String, Integer> missMap = MapStringOccurrences.countSubstringOccurrences("mississippi", 4);
    ...
    void testCountSubstringOccurrencesEmpty() {
        ...
        Map<String, Integer> adsMap = MapStringOccurrences.countSubstringOccurrences("ads", 4);
    ...
    void testCountAllSubstringOccurrences() {
        ...
        // (ads, 1)
        Map<String, Integer> adsMap = MapStringOccurrences.countSubstringOccurrences("ads");
        Map<String, Integer> adsExpected = new HashMap<>();
        adsExpected.put("a", 1);
        adsExpected.put("d", 1);
        adsExpected.put("s", 1);
        ...
        // 1)
        Map<String, Integer> pMap = MapStringOccurrences.countSubstringOccurrences("ppppp");
    ...
    void testRepeatedSubstrings() {
        ...
        pInput.put("pppp", 2);
        pInput.put("ppppp", 1);
        MapStringOccurrences.repeatedSubstrings(pInput);
        Map<String, Integer> pExpected = new HashMap<>();
        pExpected.put("p", 5);
        pExpected.put("pp", 4);
        pExpected.put("ppp", 3);
    ...
    void testRepeatedSubstringsEmpty() {
        ...
        adsInput.put("ds", 1);
        adsInput.put("ads", 1);
        MapStringOccurrences.repeatedSubstrings(adsInput);
        Map<String, Integer> adsExpected = new HashMap<>();
